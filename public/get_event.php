...
$me=$_SESSION['user']; $canDelete = ($me['role']==='admin')||((int)$me['id']===(int)$row['initiated_by']);
header('Content-Type: application/json');
echo json_encode([
  'id'=>$row['id'],'title'=>$row['title'],
  'start'=>gmdate('Y-m-d H:i', strtotime($row['start_at'])), 'end'=>gmdate('Y-m-d H:i', strtotime($row['end_at'])),
  ...
  'initiator_name'=>$row['initiator_name'],'initiator_email'=>$row['initiator_email'],'can_delete'=>$canDelete
]);
